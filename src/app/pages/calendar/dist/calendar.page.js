...
var CalendarPage = /** @class */ (function () {
    function CalendarPage(ordersService, calendarService) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.ordersService.find()];
                    case 1:
                        _a.orders = _b.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                this.calendarOptions = {
                    ...
                    events: this.orders.map(function (res) {
                        var id = res.id.toString();
                        return { title: "CONSEGNA ORDINE N° :" + id, date: res.deliveryDate };
                    })
                };
                setTimeout(function () {
                    _this.calendarComponent.getApi().next = function () { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    _a = this;
                                    return [4 /*yield*/, this.calendarService.currentData(this.calendarComponent.getApi())];
                                case 1:
                                    _a.orders = _b.sent();
                    ...
                    _this.calendarComponent.getApi().prev = function () { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
    ...
    ], CalendarPage.prototype, "calendarComponent");
